...
export const metadata = {
  title: 'Terms of Service — Meta Gallery',
  description: 'Terms and conditions for using Meta Gallery platform and services.',
}
        ...
        <div className={styles.contentContainer}>
          ...
          <div className={styles.contentBody}>
            ...
            <article id="acceptance" className={styles.section}>
              ...
              <p>
                Welcome to Meta Gallery. These Terms of Service ("Terms") govern your access to and use of the Meta Gallery website, mobile applications, AR services, and any related services (collectively, the "Platform") operated by Meta Gallery Ltd ("we," "our," or "us").
              </p>
              <p>
            ...
            <article id="platform-use" className={styles.section}>
              ...
              <p>
                Meta Gallery provides an augmented reality platform that enables galleries, museums, and artists to enhance visitor experiences with digital overlays, audio guides, and interactive content.
              </p>
            ...
            <article id="gallery-artist-terms" className={styles.section}>
              ...
              <p>
                You retain ownership of all artwork images, descriptions, audio guides, and other content you upload to the Platform. By uploading content, you grant Meta Gallery a non-exclusive, worldwide, royalty-free licence to display, distribute, and promote your content in connection with the Platform.
              </p>
            ...
            <article id="marketplace" className={styles.section}>
              ...
              <p>
                The Meta Gallery Marketplace allows artists and galleries to sell original works, prints, and merchandise.
              </p>
              <h3>For Sellers</h3>
              <ul>
                ...
                <li>Meta Gallery charges a 10% commission on completed sales</li>
                <li>Payouts are processed within 7 business days of delivery confirmation</li>
              </ul>
              <h3>For Buyers</h3>
              <ul>
                <li>All sales are between you and the seller; Meta Gallery facilitates the transaction</li>
                ...
                <li>Disputes should first be raised with the seller before contacting Meta Gallery</li>
              </ul>
              <h3>Buyer Protection</h3>
              <p>
                Meta Gallery offers buyer protection for qualifying purchases. If an item is significantly not as described or fails to arrive, you may be eligible for a full refund. Claims must be filed within 14 days of expected delivery.
              </p>
            </article>

            <article id="intellectual-property" className={styles.section}>
              <h2>8. Intellectual Property</h2>
              <h3>Meta Gallery IP</h3>
              <p>
                The Platform, including its design, features, code, and branding, is owned by Meta Gallery Ltd and protected by intellectual property laws. You may not copy, modify, or create derivative works without our written permission.
              </p>
              <h3>Trademarks</h3>
              <p>
                "Meta Gallery," our logo, and other marks are trademarks of Meta Gallery Ltd. You may not use these marks without our prior written consent.
              </p>
              <h3>Feedback</h3>
              <p>
            ...
            <article id="payments" className={styles.section}>
              ...
              <h3>Commission</h3>
              <p>
                Meta Gallery charges a 10% commission on all Marketplace sales. This fee is deducted from the sale price before payout to the seller.
              </p>
            ...
            <article id="indemnification" className={styles.section}>
              ...
              <p>
                You agree to indemnify, defend, and hold harmless Meta Gallery and its officers, directors, employees, agents, and affiliates from any claims, damages, losses, liabilities, costs, and expenses (including legal fees) arising from:
              </p>
              <ul>
            ...
            <article id="contact" className={styles.section}>
              ...
              <div className={styles.contactCard}>
                ...
                <p>London, EC1A 1BB</p>
                <p>United Kingdom</p>
                <p>Email: <a href="mailto:legal@metagallery.art">legal@metagallery.art</a></p>
              </div>
            </article>
